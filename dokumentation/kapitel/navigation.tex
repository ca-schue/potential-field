...
\begin{figure}[H]
	\centering
	\footnotesize
	\centerline{\resizebox{0.63\linewidth}{!}{\includegraphics{bilder/force-field.png}}}
	\vspace*{-0.23cm}
...
$x+1$ (rechts)                                                               & \texttt{potential[rotation, y, x] - potential[rotation, y, x-1]} & $<0$                               \\ \hline
$x-1$ (links)                                                                & \texttt{potential[rotation, y, x+1] - potential[rotation, y, x]} & $>0$                                \\ \hline
